          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            ...
            >
              ...
              <p className="text-xl md:text-3xl text-slate-600 leading-tight font-light italic">
                "We are committed to manage funds for investors all around Nigeria and in the diaspora with the desire to be more reliable, trusted and efficient fund managers."
              </p>
                ...
                <div key={m.id} className="bg-white rounded-2xl shadow-sm border border-slate-200 flex flex-col overflow-hidden">
                  <div className="h-40 overflow-hidden relative">
                    ...
                    <div className="absolute bottom-2 left-2">
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase shadow-sm ${m.category === 'management' ? 'bg-accent text-primary' : m.category === 'board' ? 'bg-slate-800 text-white' : 'bg-primary text-white'}`}>
                        {m.category}
                      </span>
                    </div>
                  </div>
